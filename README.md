...
Proof is a private, phone-first PWA for weekly Sunday body-progress check-ins: a required front photo, optional side photo, weight in kg, and a short note. Photos stay on this device in IndexedDB (entry metadata in localStorage). There is no login, cloud sync, or AI in v1.
